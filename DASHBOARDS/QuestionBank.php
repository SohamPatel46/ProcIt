                ...
                <div style="height: 60px;" class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <a href="AddDataBaseQuestion.php?courseid=<?php echo $Courseid ?>"><button type="button" class="btn btn-outline-secondary btn-xs" style="float: right; margin-right: 20px;">Add Question </button></a>
            ...
            <!-- Dark table start -->
                    <div class="col-12 mt-5">
                        <div class="card" style="margin-top: -30px;">
                            <div class="card-body">
                                <h4 class="header-title">Question Bank</h4>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center" style="width:100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                $ID = $_SESSION['ID'];
                                                $select_question_bank_subject = "SELECT * FROM `add_database_question` WHERE ID=$ID && Course_Id='$Courseid'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><button class="btn btn-outline-secondary btn-xs " data-toggle="modal" data-target="#edit[<?php echo $i; ?>]"><i class="fa fa-edit"></i></button></li>   
                                                        <div class="modal fade" id="edit[<?php echo $i; ?>]">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Edit DB Question</h5>
                                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <p>Are you Sure Want to Edit  the Question From DataBase? </p>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
                                                                        <a href="EditDBQuestion.php?Cid=<?php echo $Courseid?>&questionid=<?php echo $row['Question_Id']; ?>&qtype=<?php echo $row['question_type'];?>"><input type="button" value="Edit" name="edit" class="btn btn-outline-secondary"></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <li class="mr-3"><button class="btn btn-outline-danger btn-xs " data-toggle="modal" data-target="#delete[<?php echo $i; ?>]"><i class="ti-trash"></i></button></li>
                                                        <div class="modal fade" id="delete[<?php echo $i; ?>]">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Delete DB Question</h5>
                                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <p>Are you Sure Want to Delete the Question From DataBase? </p>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
                                                                        <a href="../DeleteDBQuestion.php?Cid=<?php echo $Courseid?>&questionid=<?php echo $row['Question_Id']; ?>"><input type="button" value="Delete" name="del" class="btn btn-outline-danger"></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
