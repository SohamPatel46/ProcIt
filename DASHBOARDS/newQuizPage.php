     ...
     <!-- sidebar menu area start -->
        ...
        <div class="main-content" style="background-color: white;">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <a href="#"><li><span>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;New Quiz </span></li></a>
            ...
            <div class="col-12" style="margin-top: -30px;">
                <div class="card mt-5" style="margin-top: -30px; width: 100%; height: auto;margin-bottom:4%;" >
                    <div class="card-body"> 
                        <h4 class="header-title" style="font-size: 25px;">New Quiz</h4>
                        <form class="needs-validation" action="../New_Quiz_Generate_Table.php" novalidate="" method="post">
                            <div class="form-row">
                                <div class="col-md-3 mb-3" >
                                    <label for="validationCustom01" style="margin-left: 3px;">Quiz name :</label>
                                    <input type="text" class="form-control" id="validationCustom01" name="quizname" placeholder="Quiz Name.." value="" required>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Enter Topic.." value=""  name="quiztopic" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>                  
                            ...
                            <div class=" input-group mb-5" style="margin-left: -13px; width: 50.7%;">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Reference Link for quiz practice..." value=""  name="referencelink" required>
                            ...
                            <script type="text/javascript">
                                function AddQuizQuestion(){
                                    window.location.href="AddQuizQuestion.html";
                                }
                            </script>
                            ...
                            <div style="margin-top: -35px;">
	                            <div class="form-row">
	                                <div class="col-md-3 mb-3">
                                        ...
                                        <input name="totalquestion" class="form-control" type="number" value="" id="example-number-input" placeholder="Enter Total Questions.." style=" margin-right: 10px;">
                                        <div class="valid-feedback">
                                    		Looks good!
                                		</div>
                                    </div>
	                                <div class="col-md-3 mb-3">
                                        ...
                                        <input name="totalmarks" class="form-control" type="number" value="" id="example-number-input" placeholder="Enter Total Marks.." >
                                        <div class="valid-feedback">
                                    		Looks good!
                                		</div>
                                    </div>               
                            ...
                            <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control" type="date" name="date" value="" placeholder="MM/DD/YYYY" id="example-date-input">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="example-date-input" style="margin-left:1px;" class="col-form-label"> Total Allowed Attempts :</label>
                                    <input class="form-control" type="number" name="attempts" value="1"  id="example-number-input">
                                </div>
                            </div>
                            <div class="form-row">
	                            <div class="col-md-3 mb-3">
	                                <label for="example-time-input" style="margin-left:1px;" class="col-form-label">Select Start Time : </label>
	                                <input class="form-control" type="time" name="stime" value="10:00:00"  id="example-time-input">
	                            </div>
	                            <div class="col-md-3 mb-3">
                                    <label for="example-time-input" style="margin-left:1px;" class="col-form-label">Select End Time : </label>
                                    <input class="form-control"  name="etime" type="time"   id="example-time-input" value="10:15:00">
                                </div>
                        	</div>
                            <div style="margin-top: 10px; margin-left: 3px;">
                                <input style=" margin-right: 20px;" name="savequiz" class="btn btn-secondary" type="submit" value="Save Quiz">
