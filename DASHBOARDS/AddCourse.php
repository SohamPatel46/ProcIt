        ...
        <div class="main-content" style="background-color: white;">
            ...
            <div class="col-12">
                <div class="card mt-5" style=" width: 100%; height: auto;" >
                    <div class="card-body"> 
                        <h4 class="header-title" style="font-size: 25px;">Register New Subject</h4>
                        <form class="needs-validation" action="../AddCourse_table.php" novalidate="" enctype="multipart/form-data" method="post">

                            <div class="form-row">
                                <div class="col-md-3 mb-3" >
                                    <label for="validationCustom01" style="margin-left: 3px;">Subject name</label>
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="Subject Name" value="" name="subname" required>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Subject ID" value="" name="subid" required >
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>                  
                            ...
                            <div>
                            <input style="margin-top: 20px; margin-right: 20px;" class="btn btn-secondary" name="addcourse" type="submit" value="Add Subject">
                            <input style="margin-top: 20px; " class="btn btn-secondary" type="reset" value="Clear">
                            </div>
                        </form>
                    </div>
                </div>
