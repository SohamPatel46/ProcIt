            ...
            <!-- Dark table start -->
                    <div class="col-12 mt-5">
                        <div class="card" style="margin-top: -30px;">
                            <div class="card-body">
                                <form action="../RandomQuestionDBSelect.php?Cid=<?php echo $Courseid; ?>&quizid=<?php echo $quizid; ?>" method="post">
                                    <h4 class="header-title" style="float:left;">Question Bank</h4>
                                    <input type="submit" class="btn btn-outline-secondary btn-xs" style="float: right;" value="Select For Quiz" name="addtoquiz_random">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <li class="mr-3"> <input style="margin-top: 3px;" type="checkbox" name="check[]" value="<?php echo $row['Question_Id']; ?>"></li>
                                                        </ul>
                                                    </td>
                                                </tr>                                                                  
                                                <?php
