        ...
        <div class="main-content" style="background-color: white;">
            ...
            <div class="col-12">
                <div class="card mt-5" style=" width: 100%; height: auto;" >
                    <div class="card-body"> 
                        <h4 class="header-title" style="font-size: 25px;">Add New Note</h4>
                        <form class="needs-validation" action="../TaskNote_table.php" novalidate="" method="post">
                            <div class="form-row">
                                <div>
                            ...
                            <div class="form-row">
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <input class="form-control" style="width: 300px;" type="date" name="date" value="" placeholder="MM/DD/YYYY" id="example-date-input">
                                </div>

                                 <div class="form-group" style="margin-left: 30px;">
                                    <label for="example-time-input" style="margin-left:1px;" class="col-form-label">Select Time : </label>
                                    <input name="time" class="form-control" type="time" style="width: 300px;" value="22:45:00"  id="example-time-input">
                                </div>
                            </div>
                            ...
                            -->
                                <div class="form-group mb-3">
                                    ...
                                    <div  style="width:628px; margin-left: 15px;">
                                        <textarea name="note" id="textarea-input" rows="3" placeholder="Add Note Here..." class="form-control"></textarea>
                                    </div>
                            ...
                            <div style="margin-top: -5px;">
                                <input style=" margin-right: 20px;" class="btn btn-secondary" type="submit" name="addTask" value="Add Task">
