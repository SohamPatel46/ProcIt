<?php
    ...
    if(isset($_POST['edit_db_question']))
    {
        $fid = $_SESSION['ID'];
        ...
        if(!file_exists($_FILES['question_img']['tmp_name']))
        {
            ...
            $edit_question_query ="UPDATE `add_database_question` SET Question='$Question',Option1='$Option_1',
                                    Option2='$Option_2',Option3='$Option_3',Option4='$Option_4',Correct_Option='$Correct_option',Topic='$topic'
