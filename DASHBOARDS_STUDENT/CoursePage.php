                ...
                <div style="height: 60px;" class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <!--<a href="#"><button type="button" class="btn btn-outline-secondary btn-xs" style="float: right;margin-right: 20px;">Question Bank</button></a>
                            <a href="#"><button type="button" class="btn btn-outline-secondary btn-xs" style="float: right;margin-right: 20px;">Reference Links</button></a>-->
                        </div>
                    </div>                    
                </div>
            </div>
        ...
        <div class="main-content-inner">
            <div class="row">
                ...
                <div class="col-md-4" style="padding-right: 85px;">
                        <div class="card" style="margin-top: 20px;height: auto;width: 300px;padding-bottom:50%;">
