...
<body>
	<?php
        ...
        $fetch_response = "SELECT * FROM `quiz_respose` WHERE ID='$sid' && Course_ID='$cid' && Quiz_ID='$quiz_id' ORDER BY Serial_number desc limit 1";
		...
		<div class="container" style="width: 100%; margin:2%; ">
			<div class="row">
				<div class="" style="width: 100%;">
					<div class="border">
						<div class="question bg-white p-3 border-bottom" style="width:105%;">
							<div class="d-flex flex-row justify-content-between align-items-center mcq">
								<h4>Score : <?php echo $score.'/'.$marks ?></h4><h4><span>Quiz Time : <?php echo $time; ?></span></h4><h4><a href="<?php echo $reference_link; ?>" target=_blank><span style="float:right;">Reference Link</span></a></h4>
							</div>
						</div>
						...
						<?php
							...
							?>					
						<div id="mcq_type">
							<div class="question bg-white p-3 border-bottom" style="height: 600px; margin-top:10px;width:105%;">
