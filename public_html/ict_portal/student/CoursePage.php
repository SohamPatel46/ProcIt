	 ...
	 <!-- sidebar menu area start -->
                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                ?>
                                <a href="#"><li><span>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<?php echo $row['Course_Name']?></span></li></a>
                            </ul>
                            <a href="Result_studentquiz.php?courseid=<?php echo $course_id; ?>&by=<?php echo $batch_year; ?>&dgdp=<?php echo $deg_dip; ?>"><button type="button" class="btn btn-outline-secondary btn-xs" style="float: right; margin-right: 20px;">Result Analysis</button></a>
                            <a href="MainQuestionBank.html"><button type="button" class="btn btn-outline-secondary btn-xs" style="float: right;margin-right: 20px;">Question Bank</button></a>
                            <button type="button" onclick="newQuizPage();" class="btn btn-outline-secondary btn-xs" style="float: right;margin-right: 20px;">Reference Links</button>
                        </div>
                    </div>                    
                </div>
            </div>
        ...
        <div class="main-content-inner">
            <div class="row">
                ...
                ?>
                <a style="text-decoration: none;" href="StartQuiz.php?courseid=<?php echo $course_id; ?>&qid=<?php echo $row['Quiz_Id']; ?>&by=<?php echo $batch_year; ?>&dgdp=<?php echo $deg_dip; ?>" >
                <div class="col-md-4" style="padding-right: 85px;">
                        <div class="card" style="margin-top: 20px;height: 270px;width: 300px;">
                            <div class="card-body" style=" height: 250px;padding: 20px;">              
                            <h5 style="color: black; text-align: center; margin-top: 7px; margin-bottom: 13px;"><?php echo $row['Quiz_Name']; ?></h5>

                            <h5 style="color: black; text-align: center; margin-bottom: 13px;"><?php echo $row['Topic']; ?></h5>
                            <h5 style="color: black; text-align: center; margin-bottom: 13px;"><?php echo $row['Quiz_Date']; ?></h5>
                            <h5 style="color: black; text-align: center; margin-bottom: 13px;"><?php echo "Start time : ".$row['Start_Time']; ?></h5>
                            <h5 style="color: black; text-align: center; margin-bottom: 13px;"><?php echo "End time : ".$row['End_Time']; ?></h5>
                            <h5 style="color: black; text-align: center; margin-bottom: 13px;"><?php echo "Marks : ".$row['Marks']; ?></h5>
                            </div>
                        </div>    
                    </div>
                </a>
